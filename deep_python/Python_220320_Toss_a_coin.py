...
axes[0, 0].set_title("그래프1.앞면 확률 - 개별 실험당 동전던지기 10회")

axes[0, 1].hist(coin_instance_100.get_prob_array())
axes[0, 1].set_xlim([0, 1])
axes[0, 1].set_title("그래프2.앞면 확률 - 개별 실험당 동전던지기 100회")

axes[1, 0].hist(coin_instance_10000.get_prob_array())
axes[1, 0].set_xlim([0, 1])
axes[1, 0].set_title("그래프3.앞면 확률 - 개별 실험당 동전던지기 10000회")

axes[1, 1].hist(coin_instance_100000.get_prob_array())
axes[1, 1].set_xlim([0, 1])
axes[1, 1].set_title("그래프4.앞면 확률 - 개별 실험당 동전던지기 100000회")
plt.show()